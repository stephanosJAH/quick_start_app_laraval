<template>
  <div>
    <div 
      ...
      class="flex items-center justify-between mt-4 mb-4 bg-green-500 rounded shadow-slate-500 drop-shadow-xl"
    >
      <div class="flex items-center">
        <icon-square-rounded-check class="shrink-0 ml-4 mr-2 w-6 h-6 stroke-white"/>
    ...
    <div 
      ...
      class="flex items-center justify-between mt-4 mb-4 bg-red-500 rounded"
    >
      <div class="flex items-center">
...
<script>
import IconSquareRoundedCheck from '@/Shared/Icons/SquareRoundedCheck.vue'
